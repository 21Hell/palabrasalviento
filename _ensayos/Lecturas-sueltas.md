...
## Ética vs. Teoría: La distinción de Graeber
...
- La ética en una barrera contra el análisis
- Restringe la producción teórica
- Impide que la práctica se someta a evaluación racional
...
1. **Escala**: Las prácticas locales pueden ser efectivas en contextos limitados, pero no abordan cómo se transforman las estructuras económicas y políticas a nivel macro.
2. **Mecanismos de poder**: El capitalismo y el Estado tienen mecanismos de reproducción y resistencia que pueden neutralizar o cooptar estas prácticas.
3. **Coexistencia con estructuras opresivas**: La autoorganización dentro de la sociedad capitalista puede coexistir con la explotación y la dominación, sin necesariamente desafiarlas.
...
## Desigualdades estructurales en sociedades sin Estado
...
## Sobredimensionar la imaginación
...
- Mondragón no es horizontal
- Linux no es democrático
- El consenso no escala a sociedades industriales
- La cooperación técnica no equivale a democracia política
- Se ignora la estructura material que sostiene toda sociedad compleja
- Se pasa por alto la violencia simbólica que ordena toda comunidad técnica
...
## Más Graeber: La violencia estructurante
...
### 1. La violencia física crea el marco básico
...
### 2. La amenaza representada se interioriza
...
### 3. La autoridad simbólica es un mecanismo más profundo
...
- Define lo que cuenta como normal o legítimo
- Marca límites que se perciben como naturales, no como imposiciones
- Produce la sensación de que desobedecer traerá consecuencias aun si no está el agente con la porra
